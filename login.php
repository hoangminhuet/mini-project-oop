...
if (isset($_REQUEST['submit'])) {
    ...
    if (isset($_COOKIE["user_login"]) && isset($_COOKIE["pass_login"])) {
        if ($_COOKIE["user_login"] == "$emailusername" && $_COOKIE["pass_login"] == "$password") {
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="login-panel panel panel-primary">
                <div class="panel-body">
                    ...
                    <div style="text-align: center;"><b>Do not have an account?</b> <br></b><a href="register.php">Register new user</a></div>
                </div>
            </div>
        </div>
    </form>
